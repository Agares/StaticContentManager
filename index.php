...
<html>
	...
	<body>
		<h1><?php echo $toRender->getTitle() ?></h1>
		<p><?php echo $templateRenderer->render($toRender, array('jaka' => 'z placeholdera')) ?></p>
	</body>
</html>